...
def get_classes_different_id():
  return {
    ...
    '4th-ventricle': {'old_id': 15, 'new_id': 20},	
    'brain-stem': {'old_id': 16, 'new_id': 21},
    'left-hippocampus': {'old_id': 17, 'new_id': 22},	
    'right-hippocampus': {'old_id': 53, 'new_id': 23},
    ...
    'ctx-rh-caudalmiddlefrontal': {'old_id': 2003, 'new_id': 46},
    'ctx-lh-cuneus': {'old_id': 1005, 'new_id': 47},	
    'ctx-rh-cuneus': {'old_id': 2005, 'new_id': 48},
    'ctx-lh-entorhinal': {'old_id': 1006, 'new_id': 49},	
    'ctx-rh-entorhinal': {'old_id': 2006, 'new_id': 50},
    'ctx-lh-fusiform': {'old_id': 1007, 'new_id': 51},	
    'ctx-rh-fusiform': {'old_id': 2007, 'new_id': 52},
    'ctx-lh-inferiorparietal': {'old_id': 1008, 'new_id': 53},
    'ctx-rh-inferiorparietal': {'old_id': 2008, 'new_id': 54},
    ...
    'ctx-lh-lateraloccipital': {'old_id': 1011, 'new_id': 59},	
    'ctx-rh-lateraloccipital': {'old_id': 2011, 'new_id': 60},
    ...
    'ctx-lh-postcentral': {'old_id': 1022, 'new_id': 81},	
    'ctx-rh-postcentral': {'old_id': 2022, 'new_id': 82},
    ...
    'ctx-lh-rostralmiddlefrontal': {'old_id': 1027, 'new_id': 91},	
    'ctx-rh-rostralmiddlefrontal': {'old_id': 2027, 'new_id': 92},
    'ctx-lh-superiorfrontal': {'old_id': 1028, 'new_id': 93},	
    'ctx-rh-superiorfrontal': {'old_id': 2028, 'new_id': 94},
    ...
    'ctx-lh-insula': {'old_id': 1035, 'new_id': 103},	
    'ctx-rh-insula': {'old_id': 2035, 'new_id': 104},
  }
...
def median_frequency_balancing(image_files, num_classes=4):
    ...
    dict_2['total'] = label_to_frequency_dict
